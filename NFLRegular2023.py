...
new_json_file_name = 'NFLSchedule2023-2.json'
...
with open(os.path.join(json_file_path, 'NFLSchedule2023-2.json'), 'w') as json_file:
...
def load_nfl_reg_full(filepath):
    ...
    with open(filepath, "r") as file:
        for line in file:
            ...
            reg_list.append(line.strip())

    # Join the list elements into a single string
    json_string = ''.join(reg_list)

    # Parse the JSON string into a Python dictionary
    nfl_reg_dict = json.loads(json_string)
...
# %%
#---------------------------------------------------------------------------------------
nfl_reg_dict = load_nfl_reg_full(filepath)
#---------------------------------------------------------------------------------------

# %%
#---------------------------------------------------------------------------------------
#this chunk scrapes the data from the json file, specifically NFLSchedule2023-2.json
...
games = nfl_reg_dict["weeks"][week_number - 1]["games"]

# Create an empty list to store the extracted data
game_details = []

# Extract the game details and add them to the list
for game in games:
    ...
    # Add 3.5 hours to the scheduled_time
